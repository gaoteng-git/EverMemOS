...
async def sync_foresight_docs(
    ...
    """
    Sync foresight documents to Elasticsearch.
    ...
    logger.info("Starting to sync foresight documents to ES...")
    ...
    try:
        async_client = ForesightDoc.get_connection()
    ...
    async def generate_actions() -> AsyncIterator[Dict[str, Any]]:
        ...
        while True:
            ...
            for mongo_doc in mongo_docs:
                es_doc = ForesightConverter.from_mongo(mongo_doc)
                src = es_doc.to_dict()
