"""
Sync foresight documents to Milvus

Bulk retrieve foresight documents from MongoDB, convert them, and insert into Milvus.
...
- Use ForesightMilvusConverter for format conversion
...
async def sync_foresight_docs(
    ...
    logger.info("Starting to sync foresight documents to Milvus...")
    ...
    try:
        # Directly use the async_collection() method of ForesightCollection
        ...
        while True:
            ...
            for mongo_doc in mongo_docs:
                try:
                    ...
                    milvus_entity = ForesightMilvusConverter.from_mongo(mongo_doc)
