...
async def sync_event_log_docs(
    ...
    """
    Sync event log documents to Elasticsearch.
    ...
    logger.info("Starting to sync event log documents to ES...")
    ...
    try:
        async_client = EventLogDoc.get_connection()
    ...
    async def generate_actions() -> AsyncIterator[Dict[str, Any]]:
        ...
        while True:
            ...
            for mongo_doc in mongo_docs:
                es_doc = EventLogConverter.from_mongo(mongo_doc)
                src = es_doc.to_dict()
