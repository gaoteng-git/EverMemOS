"""
Sync event log documents to Milvus

Bulk retrieve event log documents from MongoDB, convert them, and insert into Milvus.
...
- Use EventLogMilvusConverter for format conversion
...
async def sync_event_log_docs(
    ...
    logger.info("Starting to sync event log documents to Milvus...")
    ...
    try:
        # Directly use the async_collection() method of EventLogCollection
        ...
        while True:
            ...
            for mongo_doc in mongo_docs:
                try:
                    ...
                    milvus_entity = EventLogMilvusConverter.from_mongo(mongo_doc)
