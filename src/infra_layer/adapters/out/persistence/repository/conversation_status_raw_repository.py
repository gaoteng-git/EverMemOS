    ...
    async def upsert_by_group_id(
        ...
        try:
            ...
            if existing_lite:
                ...
                logger.debug(f"Updated conversation status: group_id={group_id}")
                print(
                ...
                try:
                    ...
                    logger.info(f"Created conversation status: group_id={group_id}")
                    print(
                    ...
                    if "E11000" in error_str and "duplicate key" in error_str:
                        ...
                        if retry_lite:
                            ...
                            retry_full = await self._conversation_status_lite_to_full(
                                retry_lite
                            )
                            if retry_full:
                                for key, value in update_data.items():
